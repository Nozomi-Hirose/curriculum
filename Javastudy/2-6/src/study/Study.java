...
public class Study {
    ...
    public static void main(String args[]) {
        ...
        // 問② 「(Calendar.MONTH) + 数値」の処理は、想定していない値とな System.out.println(calendar.get(Calendar.DATE));る可能性があります。以下にその理由を記述。
        /* 月を表すMONTHの値は0から始まるため+数値にしている（0→1月となるように+1しないといけない。）
         繰り上げや繰り下げの対応をしたい場合、getメソッドで対応してしまうと、「13月、14月、15月」という表示になってしまう。
         （「月の値 + 1」のため）
         →対応策としてcal.add(年月日, 調整したい値)を使用する。
        */
