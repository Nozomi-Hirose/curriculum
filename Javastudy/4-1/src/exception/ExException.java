...
public class ExException {
        ...
        do {
            ...
            try {
                ...
                switch (parameter) {
                    ...
                    // ここへ記述
                    	String[] tigauhairetsu = {"tigau", "yatsu", "yade"};
                    	System.out.println(tigauhairetsu[4]);
     ...
     */
    private static void Frappuccinoninni() throws NullPointerException {
    	String hogeOfficeninni = null;
    			if(hogeOfficeninni == null) {
